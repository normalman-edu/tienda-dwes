...
class Producto
{
    ...
    public function getHtml(){
      ...
      $str .= "<a href='./carro.php?action=add&id=" . $this->id . "&cantidad=1&redirect=".$_SERVER["REQUEST_URI"]."' class='btn btn-danger' style='position:absolute; bottom:4px; right:4px'>Comprar</a>";
    ...
    public function getThumbnailHtml(){
      ...
      $str = "<div class='col-sm-4 col-lg-4 col-md-4'>";
        $str .= "<div class='thumbnail' style='position:relative'>";
          ...
          $str .= "<a href='./carro.php?action=add&id=" . $this->id . "&cantidad=1&redirect=".$_SERVER["REQUEST_URI"]."' class='btn btn-danger'>Comprar</a>";
        $str .= "</div>";
      $str .= "</div>";
      return $str;
